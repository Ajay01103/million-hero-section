...
import TextLogo from "@/assets/texts.webp"
        ...
        <div className="relative pt-20 md:pt-36 ml-auto">
          <div className="lg:w-[70%] text-center mx-auto">
            <h1 className="text-zinc-900 dark:text-white font-extrabold text-5xl md:text-6xl xl:text-7xl">
              {translations["en-US"].hero.makeReact}{" "}
              <span className="gradient-text inline-block">
                <CountUp
                  ...
                  useEasing
                />
                % {translations["en-US"].hero.faster}
              </span>
            </h1>
            <p className="mt-8 text-xl text-zinc-600 dark:text-zinc-300 leading-8">
              {translations["en-US"].hero.the}{" "}
              <span className="font-medium dark:text-zinc-100">
                {translations["en-US"].hero.dropIn}
              </span>{" "}
              {translations["en-US"].hero.forReact}{" "}
              <Link
                href="/docs/introduction"
                className="font-medium hover:underline"
              >
                {translations["en-US"].hero.now}
              </Link>
              !
            </p>
              ...
              >
                ...
                >
                  <span className="relative whitespace-pre text-center text-base font-semibold leading-none tracking-tight text-white z-10">
                    {translations["en-US"].hero.getStarted}
                  </span>
                </ShimmerButton>
              </Link>
              <Link
            ...
            >
              <p className="text-sm text-zinc-800 dark:text-zinc-400 font-mono">
                ~ npx million@latest
              </p>
              <div className="opacity-0 group-hover:opacity-100 text-xs text-zinc-800 dark:text-zinc-300 transition-opacity">
                {submitted ? (
                  <svg
  ...
  return (
    <div className="mt-36 text-center lg:mt-32">
      <div className="uppercase text-sm font-semibold tracking-wider text-zinc-600 dark:text-zinc-400">
        {translations["en-US"].hero.trustedBy}{" "}
        <span className="dark:text-white text-#000000 semibold">3M+</span>{" "}
        {translations["en-US"].hero.users}
      </div>
